                                        ...
                                        <div class="tab-content border-x border-bottom p-3" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade" id="tab-contact" role="tabpanel" aria-labelledby="contact-tab">
                                                ...
                                                $payments_sql = mysqli_query(
                                                    $mysqli,
                                                    "SELECT * FROM payments WHERE payment_rental_id = '{$_GET['view']}'"
                                                );
                                                ...
                                                ?>
                                                                            ...
                                                                            <tr>
                                                                                <td class="align-middle">
                                                                                    <h6 class="mb-0 text-nowrap">
                                                                                        Rental of <?php echo $rentals['car_reg_number']; ?>
                                                                                    </h6>
                                                                                    <p class="mb-0">
                                                                                        from <?php echo date('d M Y', strtotime($rentals['rental_from_date'])); ?> to
                                                                                        <?php echo date('d M Y', strtotime($rentals['rental_to_date'])); ?>
                                                                                    </p>
                                                                                </td>
                                                    ...
                                                    <h4 class="text-center text-danger">
                                                        No payment records available for this rental.
                                                    </h4>
                                                <?php } ?>
                                            </div>
                                        </div>
