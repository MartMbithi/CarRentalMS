...
if (isset($_POST['CMS_Save'])) {
    $cms_email = mysqli_real_escape_string($mysql, $_POST['cms_email']);
    $cms_contacts = mysqli_real_escape_string($mysql, $_POST['cms_contacts']);
    $cms_address = mysqli_real_escape_string($mysql, $_POST['cms_address']);
    $cms_about = mysqli_real_escape_string($mysql, $_POST['cms_about']);
    $cms_faq = mysqli_real_escape_string($mysql, $_POST['cms_faq']);
    $cms_cookie_policy = mysqli_real_escape_string($mysql, $_POST['cms_cookie_policy']);
    $cms_id = mysqli_real_escape_string($mysql, $_POST['cms_id']);
