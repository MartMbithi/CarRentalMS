        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 col-xxl-6 mb-3 pr-md-2">
                        <div class="card h-md-100 verflow-hidden">
                            ...
                            <div class="card-body position-relative">
                                <h6>My Car rentals</h6>
                                <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-info">
                                    <?php echo $car_rentals; ?>
                                </div>
                                <a class="font-weight-semi-bold fs--1 text-nowrap" href="backoffice_my_rentals">All rentals
                    ...
                    <div class="col-md-6 col-xxl-6 mb-3 pr-md-2">
                        <div class="card h-md-100 verflow-hidden">
                            ...
                            <div class="card-body position-relative">
                                ...
                                <a class="font-weight-semi-bold fs--1 text-nowrap" href="backoffice_my_payments">All payments
                                    <span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span>
                                </a>
                            </div>
                        </div>
