<!-- Delete Categories -->
<div class="modal fade" id="delete_<?php echo $payment['payment_id']; ?>" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form method="POST">
                <div class="modal-body text-center text-danger">
                    <i class="fas fa-exclamation-triangle fa-4x"></i><br>
                    <h5>Heads up!, you are about to delete <?php echo $payment['payment_ref_code']; ?> details</h5>
