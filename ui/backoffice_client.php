        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                $client_sql = mysqli_query(
                    $mysqli,
                    "SELECT * FROM clients WHERE client_id = '{$_GET['view']}'"
                );
                if (mysqli_num_rows($client_sql) > 0) {
                    while ($clients = mysqli_fetch_array($client_sql)) {
                        /* Image Url */
                        if (!empty($clients['client_dpic'])) {
                            $client_image_url = '../storage/users/' . $clients['client_dpic'];
                        } else {
                ...
                ?>
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h4 class="mb-1"> <?php echo $clients['client_names']; ?>
                                        ...
                                        <h5 class="fs-0 font-weight-normal">Email: <?php echo $clients['client_email']; ?></h5>
                                        <h5 class="fs-0 font-weight-normal">ID number: <?php echo $clients['client_id_no']; ?></h5>
                                        <hr class="border-dashed my-4 d-lg-none" />
                                    </div>
                                    <div class="col-lg-6">
                                        <h5 class="fs-0 font-weight-normal">ID number: <?php echo $clients['client_id_no']; ?></h5>
                                        <h5 class="fs-0 font-weight-normal">Contacts: <?php echo $clients['client_phone_number']; ?></h5>
                                        <h5 class="fs-0 font-weight-normal">Client Since: <?php echo $clients['client_date_joined']; ?></h5>
                                        <hr class="border-dashed my-4 d-lg-none" />
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="tab-content border-x border-bottom p-3" id="myTabContent">
                                                ...
                                                <form method="POST">
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input name="client_id" type="hidden" class="form-control" value="<?php echo $clients['client_id']; ?>" required>
                                                            <input name="client_names" type="text" class="form-control" value="<?php echo $clients['client_names']; ?>" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationTooltip02">Email address</label>
                                                            <input name="client_email" type="email" class="form-control" value="<?php echo $clients['client_email']; ?>" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationTooltip02">National ID Number</label>
                                                            <input name="client_id_no" type="text" class="form-control" value="<?php echo $clients['client_id_no']; ?>" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationTooltip02">Mobile Phone Number</label>
                                                            <input name="client_phone_number" type="text" class="form-control" value="<?php echo $clients['client_phone_number']; ?>" required>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label for="validationTooltip02">Address</label>
                                                            <textarea name="client_address" type="text" class="form-control" required><?php echo $clients['client_address']; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="text-right">
                                                        <button class="btn btn-primary" type="submit" name="Update_Client">Update profile</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="tab-pane fade" id="tab-profile" role="tabpanel" aria-labelledby="profile-tab">
                                                <form method="POST">
                                                    ...
                                                    <div class="text-right">
                                                        <button class="btn btn-primary" type="submit" name="Update_Client_Passwords">Update passwords</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
